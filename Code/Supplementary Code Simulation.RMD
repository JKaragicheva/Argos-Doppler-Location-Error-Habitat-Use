...
Load Argos (PTT) location error parameters of 14 individual Black-tailed Godwits' tracks. 
```{r, eval=FALSE}
act_god <- read.csv(file='Godwits_PTT_error_ellipse_parameters_for_simulation.csv',stringsAsFactors=F)
```
